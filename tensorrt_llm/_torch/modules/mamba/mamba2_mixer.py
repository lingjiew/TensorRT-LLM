    ...
    def __init__(
        ...
        *,
        ...
        if os.environ.get("TLLM_USE_FLASHINFER_SELECTIVE_STATE_UPDATE",
            ...
            self.use_flashinfer_selective_state_update = True
        else:
            ...
            self.use_flashinfer_selective_state_update = False
        ...
        **kwargs,
        ...
        if num_decodes > 0:
            ...
            if is_target_verify:
                ...
                if self.use_flashinfer_selective_state_update:
                    self.fi_selective_state_update_y = self.selective_state_update_func(
                        ssm_states,
                        x_d,
                        dt_d,
                        A,
